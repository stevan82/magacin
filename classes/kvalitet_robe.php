...
class KvalitetRobe implements iDefault{
  // Properties
  public $id;
  public $naziv;
  public $conn;
  ...
  $sql = "INSERT INTO mgc_kvalitet_robe (naziv) VALUES ('".$naziv."')";
...
if ($this->conn->query($sql) === TRUE) {
  ...
  $sql = "UPDATE mgc_kvalitet_robe SET naziv='".$naziv."' WHERE id=".$id;
 ...
 function delete($id){
$sql = "DELETE FROM mgc_kvalitet_robe WHERE id= ('".$id."')";
