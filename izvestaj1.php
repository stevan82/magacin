...
?>
  ...
  <div class="w3-panel">
    ...
    echo "Radnik:<option value=" . $row["id"]. " ".$selected.">" . $row["naziv"]. "</option> ";
	}
	}
?>
		</select><br>
...
echo "</table>";
echo "<a href='izvestaj1print.php?radnik=".$_POST['radnik']."&godina=".$_POST['godina']."' target='_blank'><img src='images/print.png' style='width:100px;height:100px'></a>";
$conn->close();
}
