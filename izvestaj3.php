...
WHERE mgc_dobavljaci.id=".$_POST['dobavljac']." AND YEAR(datum_izdavanja)=".$_POST['godina'].
" UNION
...
WHERE mgc_dobavljaci.id=".$_POST['dobavljac']." AND YEAR(datum_vracanja)=".$_POST['godina']."
...
echo "</table>";
echo "<a href='izvestaj3print.php?dobavljac=".$_POST['dobavljac']."&godina=".$_POST['godina']."' target='_blank'><img src='images/print.png' style='width:100px;height:100px'></a>";
$conn->close();
}
